...
<div class="container">
 ...
 <p class="smallText">This page to manage question in course</p>
  <a href="/admin/add_question">Create Question</a>
  <table class="table">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    <tr v-for="(q,index) in questions" :key="q.id">
      ...
      <td>
        <button id="editBtn" class="brn"><i class="fas fa-pencil-alt"></i></button>
        <button id="deleteBtn" class="btn"><i class="fas fa-trash-alt"></i></button>
        <button id="answer_manage" class="btn" @click="manageAnswer(q.id)">Answer</button>
      </td>
    </tr>
  </tbody>
</table>
